...
projects =
    ...
    , { name = "bregydoc/gtranslate"
      ...
      , description = "Google translate API for unlimited* and free translations."
      , language = Content.Projects.Go
      , stars = 95
      }
    , { name = "bregydoc/bcidatasetIV2a"
      , link = "https://github.com/bregydoc/bcidatasetIV2a"
      , description = "This is a repository for BCI Competition 2008 motor imagery dataset IV 2a fixed and optimized for python and numpy."
      , language = Content.Projects.Python
      , stars = 28
      }
    , { name = "minskylab/neocortex"
      , link = "https://github.com/minskylab/neocortex"
      , description = "\u{1F9E0}Neocortex is a tool to connect your cognitive service \u{1F916} with your communication channels  📞to create amazing chatbots."
      , language = Content.Projects.Go
      , stars = 19
      }
